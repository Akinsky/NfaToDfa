...
Link.prototype.getAnchorPoint = function()
{
	...
	return {'x': this.nodeA.x + dx * this.parallelPart - dy * this.perpendicularPart / scale,'y': this.nodeA.y + dy * this.parallelPart + dx * this.perpendicularPart / scale};
};
...
window.onload = function()
{
  ...
  {
    download(localStorage['fsm'], "NFA.json",'text/plain');
  });
